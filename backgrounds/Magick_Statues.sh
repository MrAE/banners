...
OUTPUT2="Statue_of_Liberty_DoG_0_1_5.png"

OUTPUT1b="Statue_of_Liberty_LoG_0x2_LIGHT.png"
OUTPUT2b="Statue_of_Liberty_DoG_0_1_5_LIGHT.png"

wget ${URL} .

#magick ${INPUT} -bias 1% -morphology Convolve LoG:0x2 ${OUTPUT1}

magick ${INPUT} -bias 0% -morphology Convolve DoG:0,1.0,5.0 ${OUTPUT2}
