...
\begin{textblock}{5}(0,0)
  \begin{tikzpicture}[scale=1.4, color = white, line width=1]
      ...
      \begin{scope}[xshift=-3cm,yshift=1cm]
        %axes
        \draw[thick, <->, color=black] (0,-1.5) -- (0,4);
...
%l3
        ...
        \draw (8,3.125) node[above,black] {$x = \dfrac{1-t^2}{1+t^2}$};
        \draw (8,2.125) node[above,black] {$y = \dfrac{2t}{1+t^2}$};
